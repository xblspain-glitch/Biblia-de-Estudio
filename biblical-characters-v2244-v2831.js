...
function renderBiblicalCharactersToolsV16433(){const home=document.getElementById('biblicalCharactersHomeV2242');if(!home)return;let tools=document.getElementById('biblicalCharactersCrudToolsV16436');if(!tools){home.insertAdjacentHTML('afterbegin','<div id="biblicalCharactersCrudToolsV16436" class="module-crud-tools"><button type="button" class="crud-add" onclick="editBiblicalCharacterV16433()">＋ Añadir</button><button type="button" class="crud-trash" onclick="openBiblicalCharactersTrashV16433()">Papelera <span id="biblicalCharactersTrashCountV16436">0</span></button></div>');tools=document.getElementById('biblicalCharactersCrudToolsV16436')}const count=document.getElementById('biblicalCharactersTrashCountV16436');if(count)count.textContent=String(biblicalCharactersTrashV16433.length)}
