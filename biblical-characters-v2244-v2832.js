...
function openBiblicalCharacterDetailV2242(id,openedFromReader){
  ...
  const returnToChapterButton=openedFromBible
    ? '<button class="return-to-reader-btn" type="button" onclick="window.returnBiblicalEntityToChapter&&window.returnBiblicalEntityToChapter()">Volver al capítulo</button>'
    : '';
