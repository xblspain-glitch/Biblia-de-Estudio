...
function enableDailyReminderPreviewOnce(){
  ...
  // En esta actualización permitimos ver una vez el nuevo aviso aunque el versículo de hoy ya se hubiera abierto.
  localStorage.removeItem('dailyVerseLastSeen');
