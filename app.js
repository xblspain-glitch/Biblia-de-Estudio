...
function ensureBiblicalLeafletMap(){
  ...
  L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',{maxZoom:19,attribution:'© OpenStreetMap contributors',detectRetina:true}).addTo(biblicalPlacesLeafletMap);
