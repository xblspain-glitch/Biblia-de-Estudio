...
$('#statsDialog')?.addEventListener('click',e=>{const journey=e.target.closest('[data-open-word-journey]');if(journey){document.getElementById('statsDialog')?.close();openMyWordJourneyV3110();return}const tile=e.target.closest('[data-stats-list]');if(tile)openStatsList(tile.dataset.statsList)});
