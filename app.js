...
const PREMIUM_PLACE_MAPS={
  belen:{
    general:"mapa-mundo-biblico-belen.webp",
    regional:"mapa-judea-belen.webp",
    generalText:"Belén se encuentra en la región de Judea, al sur de Jerusalén, en la tierra de Israel.",
    regionalText:"Belén está a unos 8 km al sur de Jerusalén, en las colinas de Judea."
  },
  "belen-de-juda":{
    general:"mapa-mundo-biblico-belen.webp",
    regional:"mapa-judea-belen.webp",
    generalText:"Belén de Judá se encuentra en Judea, al sur de Jerusalén, en la tierra de Israel.",
    regionalText:"Belén de Judá está situada a unos 8 km al sur de Jerusalén, cerca de Hebrón y del mar Muerto."
  }
};
...
function premiumPlaceMapsBlock(place){
  ...
  return `<section class="place-geography-premium">
    ...
    <article class="place-geography-view">
      ...
      <button type="button" class="place-map-image-button" onclick="openPremiumPlaceMap('${escapeHtml(maps.general)}','${name} · Ubicación en el mundo bíblico')">
        <img src="${escapeHtml(maps.general)}?v=${APP_VERSION}" alt="Mapa general con la ubicación de ${name}" loading="lazy">
      </button>
    </article>
    <article class="place-geography-view">
      <div class="place-geography-copy">
      ...
      <button type="button" class="place-map-image-button" onclick="openPremiumPlaceMap('${escapeHtml(maps.regional)}','${name} · Ubicación en la región')">
        <img src="${escapeHtml(maps.regional)}?v=${APP_VERSION}" alt="Mapa regional con la ubicación de ${name}" loading="lazy">
      </button>
    </article>
  </section>`;
}
...
function applyPremiumMapTransform(){
  const img=document.querySelector("#premiumPlaceMapModal .premium-place-map-zoom img");
  if(!img)return;
  img.style.transform=`translate(${premiumMapZoomState.x}px,${premiumMapZoomState.y}px) scale(${premiumMapZoomState.scale})`;
}
...
function openPremiumPlaceMap(src,title){
