...
async function init(){
  ...
  if('caches' in window){
    try{
      ...
      await Promise.all(cacheNames.filter(name=>name.startsWith('biblia-estudio-')&&name!=='biblia-estudio-v2.0.2').map(name=>caches.delete(name)));
...
/* V2.0.2 · Efecto visual del cambio de capítulo. */
