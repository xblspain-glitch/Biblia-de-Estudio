...
const BIBLICAL_ATLAS_LABELS=[
  ...
  {name:'FENICIA',lat:33.8,lon:35.4,minZoom:5,maxZoom:9,type:'region'},
  {name:'GALILEA',lat:32.8,lon:35.35,minZoom:6,maxZoom:10,type:'region'},
  {name:'SAMARIA',lat:32.2,lon:35.22,minZoom:6,maxZoom:10,type:'region'},
  {name:'JUDEA',lat:31.58,lon:35.16,minZoom:6,maxZoom:10,type:'region'},
  {name:'PEREA',lat:31.85,lon:35.65,minZoom:7,maxZoom:11,type:'region'},
  {name:'DECAPOLIS',lat:32.45,lon:35.82,minZoom:7,maxZoom:11,type:'region'},
  {name:'IDUMEA',lat:30.9,lon:35.05,minZoom:7,maxZoom:11,type:'region'},
  {name:'MOAB',lat:31.25,lon:35.72,minZoom:6,maxZoom:10,type:'region'},
  {name:'AMÓN',lat:31.95,lon:35.93,minZoom:6,maxZoom:10,type:'region'},
  {name:'EDOM',lat:30.35,lon:35.45,minZoom:6,maxZoom:10,type:'region'},
  ...
  {name:'Mar de Galilea',lat:32.81,lon:35.59,minZoom:8,maxZoom:14,type:'water'},
  {name:'Mar Muerto',lat:31.50,lon:35.48,minZoom:7,maxZoom:13,type:'water'}
];
