...
async function resetCompletedBookProgressV3153(){
  ...
  saveChapterReadingProgressV316();closeBookCompletionDialogV3131();state.chapter=1;await loadChapter();toast(`Progreso de ${displayBook(book)} reiniciado`);
}
...
const BACKUP_KEYS=[
  ...
  CHAPTER_READING_PROGRESS_KEY_V316,BOOK_READING_HISTORY_KEY_V3153,
