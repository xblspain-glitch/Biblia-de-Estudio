...
let premiumMapZoomState={scale:1,x:0,y:0,pointers:new Map(),lastDistance:0,lastCenter:null,dragging:false,lastX:0,lastY:0};
...
function resetPremiumMapZoom(){
  premiumMapZoomState={scale:1,x:0,y:0,pointers:new Map(),lastDistance:0,lastCenter:null,dragging:false,lastX:0,lastY:0};
...
function zoomPremiumMapBy(factor){
  ...
  if(premiumMapZoomState.scale===1){premiumMapZoomState.x=0;premiumMapZoomState.y=0}
  applyPremiumMapTransform();
}
