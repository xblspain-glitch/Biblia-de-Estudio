...
let biblicalPlacesLeafletMap=null,biblicalPlacesLeafletClusters=null,biblicalPlacesLeafletMarkers=new Map(),activeBiblicalMapPlaceId='',biblicalPlacesMapFromDetail=false;
...
function ensureBiblicalLeafletMap(){
  ...
  L.tileLayer('https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png',{subdomains:'abcd',maxZoom:20,attribution:'© OpenStreetMap contributors © CARTO',detectRetina:false}).addTo(biblicalPlacesLeafletMap);
