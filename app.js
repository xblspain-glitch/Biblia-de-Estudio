...
const PREMIUM_PLACE_MAPS={"jerusalen":{"rx":40.7,"ry":26.3,"label":false,"generalText":"Jerusalén pertenece a Judea, en la zona montañosa central de la tierra de Israel.","regionalText":"Jerusalén ocupa las colinas centrales de Judea, al oeste del valle del Jordán y del mar Muerto."},"belen":{"rx":40.1,"ry":42.0,"label":true,"generalText":"Belén pertenece a Judea, al sur de Jerusalén, en la tierra de Israel.","regionalText":"Belén está situada a unos 8 km al sur de Jerusalén, en las colinas de Judea."},"belen-de-juda":{"rx":40.1,"ry":42.0,"label":true,"generalText":"Belén de Judá pertenece a Judea, al sur de Jerusalén.","regionalText":"Belén de Judá corresponde a la ciudad situada a unos 8 km al sur de Jerusalén."},"betania":{"rx":49.2,"ry":29.6,"label":false,"generalText":"Betania pertenecía a Judea y se encontraba muy cerca de Jerusalén.","regionalText":"Betania estaba al este de Jerusalén, en la ladera oriental del monte de los Olivos."},"jerico":{"rx":74.0,"ry":13.2,"label":false,"generalText":"Jericó se encontraba en el límite oriental de Judea, junto al valle del Jordán.","regionalText":"Jericó está situada al noroeste del mar Muerto, en la llanura del Jordán."},"hebron":{"rx":21.3,"ry":74.9,"label":false,"generalText":"Hebrón pertenece a la zona montañosa del sur de Judea.","regionalText":"Hebrón se encuentra al sur de Belén, en una de las regiones habitadas más antiguas de Judea."},"monte-de-los-olivos":{"rx":45.0,"ry":27.5,"label":true,"generalText":"El monte de los Olivos se levanta inmediatamente al este de Jerusalén, dentro de Judea.","regionalText":"Está separado de Jerusalén por el valle de Cedrón y se extiende hacia Betania y Betfagé."}};

function premiumRegionalMarker(maps,name){
  const label=maps.label?`<span class="premium-map-label">${escapeHtml(name)}</span>`:"";
  return `<span class="premium-map-marker" style="left:${maps.rx}%;top:${maps.ry}%" aria-hidden="true"><span class="premium-map-pin"></span>${label}</span>`;
}
...
function premiumPlaceMapsBlock(place){
  ...
  const general="mapa-mundo-biblico-judea.webp";
  const regional="mapa-judea-maestro.webp";
    ...
    <article class="place-geography-view">
      ...
      <button type="button" class="place-map-image-button" onclick="openPremiumPlaceMap('${general}','Judea · Ubicación en el mundo bíblico',null,null,'')">
        <span class="premium-map-stage">
          <img src="${general}?v=${APP_VERSION}" alt="Mapa general de Judea en el mundo bíblico" loading="lazy">
        </span>
      </button>
    </article>
    <article class="place-geography-view">
      ...
      <button type="button" class="place-map-image-button" onclick="openPremiumPlaceMap('${regional}','${escapeHtml(name)} · Ubicación en Judea',${maps.rx},${maps.ry},'${maps.label?escapeHtml(name):""}')">
        <span class="premium-map-stage">
