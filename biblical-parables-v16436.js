...
async function ensureLoaded(){
 ...
 let defaults=[];try{defaults=await fetch('./biblical-parables.json?v=1.64.35',{cache:'no-store'}).then(r=>r.json())}catch(e){}
